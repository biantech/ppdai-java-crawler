...
public class PPdaiHtmlUnitAndJsoup {
    Logger logger = LoggerFactory.getLogger(PPdaiHtmlUnitAndJsoup.class);
   ...
   public void HtmlUnitBaiduAdvanceSearch() {
    ...
    public void jsoupParse() {
        try {
            ...
            for (HtmlAnchor ach : achList) {
                logger.info(ach.getHrefAttribute());
            }
    ...
    public void proxy() {
        ...
        int port = 80;
        WebClient webClient = new WebClient(BrowserVersion.CHROME, proxyHost,port);
        webClient.setAjaxController(new NicelyResynchronizingAjaxController());
    ...
    public void jsoupCrawl() throws IOException {
        ...
        logger.info(loginBtn.text());// 获取节点中的文本，类似于js中的方法
    }
}
